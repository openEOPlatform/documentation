...
Workspaces are an abstraction of object-storage for openEO. They allow you to have more control over their data, from where it is saved, to where it is loaded from.
