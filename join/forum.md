...
The [Forum](https://discuss.eodc.eu/c/openeo-platform/5) is a communication point between openEO Platform users and developers. Anyone on the web can read the major Forum categories and their entries.   

To get access to the Forum you need to follow 2 simple steps:
